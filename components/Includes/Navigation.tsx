    ...
    return (
        <>
            <div className="bg-gray-200 h-full w-full">
                {/* Code block starts */}
                <nav className="bg-white shadow xl:block hidden fixed top-0 w-full">
                            ...
                            <div className="flex">
                                ...
                                <div className="hidden xl:flex items-center">
                                    <div className="relative md:mr-6 my-2">
                                        <Link href={'/sign-in'}>
                                            <a className="focus:outline-none border-indigo-500 border transition duration-150 ease-in-out hover:bg-indigo-400 hover:text-white rounded text-gray-600 px-5 py-2 text-xs mr-3">Login</a>
                                        </Link>
                                        <Link href={'/sign-up'}>
                                            <a className="focus:outline-none border-indigo-500 border transition duration-150 ease-in-out hover:bg-indigo-400 hover:text-white rounded text-gray-600 px-5 py-2 text-xs">Register</a>
                                        </Link>
                                    </div>
