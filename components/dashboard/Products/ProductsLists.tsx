									...
									{props.products.map((product: any, index: any) => {
										return (
											<tr key={index} className='h-16 border border-gray-100 rounded'>
												...
												<td className='pl-5'>{product.status == 1 ? <button className='py-3 px-3 text-sm focus:outline-none leading-none text-blue-500 bg-blue-100 hover:bg-blue-200 rounded'>Active</button> : <button className='py-3 px-3 text-sm focus:outline-none leading-none text-red-500 bg-red-100 hover:bg-red-200 rounded'>In-active</button>}</td>
												<td className='pl-4'>
