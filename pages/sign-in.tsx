...
const SignIn: NextPage = () => {
    ...
    return (
			<>
				...
				<div
					className='h-screen bg-gradient-to-b from-indigo-400 to-indigo-900 w-full flex flex-wrap justify-center items-center'
					style={{
				...
				>
					<div className='flex flex-col items-center justify-center' style={styles.wrapperContent}>
						...
						<div className='bg-white shadow rounded w-full p-10 mt-16' style={styles.loginContent}>
							...
							{ error!='' && (
                                <p className='text-red-500 text-sm text-center bg-red-100 p-1 rounded'>{error}</p>
                            )}
